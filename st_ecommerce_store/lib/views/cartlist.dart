...
class cartlist_view extends StatelessWidget {
  List cartitems;

  cartlist_view({super.key, required this.cartitems});
              ...
              child: Container(
                  ...
                  child: Container(
                    child: Row(
                      children: [
                        Image(
                          image: AssetImage(cartitems[index].product_img),
                          height: 100,
                          width: 100,
                          fit: BoxFit.cover,
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                width: 100,
                                child: Text(cartitems[index].product_name,
                                    style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.w700)),
                              ),
                              spacer(spacer_height: 10),
                              Text(cartitems[index].product_price,
                                  style: TextStyle(
                                      fontSize: 20,
