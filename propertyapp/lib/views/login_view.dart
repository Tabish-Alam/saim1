...
class _login_viewState extends State<login_view> {
  ...
  var errorText;
  login_check() {
    if (user_email == "123" && user_password == "12345") {
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          customtextfield(selecticon: (Icons.mail), placeholder: "Email"),
          custompassword(
          ...
          Text("or continue with",
              style: TextStyle(
                  color: selectcolor().greytextcolor,
                  fontWeight: FontWeight.w500)),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              image_button(img_path: "Assets/images/fb_logo.png"),
              image_button(img_path: "Assets/images/google_logo.png"),
              image_button(img_path: "Assets/images/apple_logo.png"),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
